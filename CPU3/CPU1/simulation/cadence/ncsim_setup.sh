...
TOP_LEVEL_NAME="CPU1"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/duesan/intelFPGA_lite/18.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/CPU1_pio_0.v"                                                -work pio_0                                        -cdslib ./cds_libs/pio_0.cds.lib                                       
